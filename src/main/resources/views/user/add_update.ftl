...
<form class="layui-form" style="width:80%;">
    <input name="id" type="hidden" value="${(user02.id)!}"/>
    ...
    <div class="layui-form-item layui-row layui-col-xs12">
        ...
        <div class="layui-input-block">
            <input type="text" class="layui-input userName"
                   ...
                   value="${(user02.userName)!}" placeholder="请输⼊⽤户名">
        </div>
    </div>
    <div class="layui-form-item layui-row layui-col-xs12">
        ...
        <div class="layui-input-block">
            <input type="text" class="layui-input userName"
                   ...
                   value="${(user02.trueName)!}" placeholder="请输⼊真实姓名">
        </div>
    </div>
    <div class="layui-form-item layui-row layui-col-xs12">
        ...
        <div class="layui-input-block">
            <input type="text" class="layui-input userEmail"
                   lay-verify="email" name="email" value="${(user02.email)!}"
                   id="email"
                   placeholder="请输⼊邮箱">
        </div>
    </div>
    ...
    <div class="layui-form-item layui-row layui-col-xs12">
        ...
        <div class="layui-input-block">
            <input type="text" class="layui-input userEmail"
                   lay-verify="phone" name="phone" value="${(user02.phone)!}" id="phone"
                   placeholder="请输⼊⼿机号">
        </div>
    </div>
